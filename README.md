# Helmify
[![CI](https://github.com/nais/helmify/actions/workflows/ci.yml/badge.svg)](https://github.com/nais/helmify/actions/workflows/ci.yml)
![GitHub go.mod Go version](https://img.shields.io/github/go-mod/go-version/nais/helmify)
![GitHub](https://img.shields.io/github/license/nais/helmify)
![GitHub release (latest by date)](https://img.shields.io/github/v/release/nais/helmify)
[![Go Report Card](https://goreportcard.com/badge/github.com/nais/helmify)](https://goreportcard.com/report/github.com/nais/helmify)
[![GoDoc](https://godoc.org/github.com/nais/helmify?status.svg)](https://pkg.go.dev/github.com/nais/helmify?tab=doc)
![GitHub total downloads](https://img.shields.io/github/downloads/nais/helmify/total)
...
See [examples](https://github.com/nais/helmify/tree/main/examples) of charts generated by helmify.
...
- With operator-sdk version < v1.23.0
    ...
    helmify:
    	$(call go-get-tool,$(HELMIFY),github.com/nais/helmify/cmd/helmify@v0.3.7)
...
- With operator-sdk version >= v1.23.0
    ...
    $(HELMIFY): $(LOCALBIN)
    	test -s $(LOCALBIN)/helmify || GOBIN=$(LOCALBIN) go install github.com/nais/helmify/cmd/helmify@latest
...
Or download suitable for your system binary from [the Releases page](https://github.com/nais/helmify/releases/latest).
